...
require "app/Logic/LuaClass"
require "app/Logic/CtrlManager"
require "app/Controller/PromptCtrl"
...
--		require ("app/View/"..tostring(PanelNames[i]))
--	end
--end
...
function Game.OnInitOK()
    ...
    AppConst.SocketAddress = "121.40.96.234";
    ...
    printWarning('LuaFramework InitOK--->>>');
end
...
function Game.test_coroutine()    
    ...
    coroutine.www(www);
    printWarning(www.text);
end

--测试sproto--
function Game.test_sproto_func()
    printWarning("test_sproto_func-------->>");
...
function Game.CalledByPlatform(content)
    printInfo("CalledByPlatform content %s",content)
end

--销毁--
function Game.OnDestroy()
	--printWarning('OnDestroy--->>>');
end
