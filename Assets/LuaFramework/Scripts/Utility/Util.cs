...
namespace LuaFramework {
    public class Util {
        ...
        public static void ClearMemory() {
            ...
            LuaManager mgr = AppFacade.Instance.GetComponentByName<LuaManager>(ComponentName.Lua);
        ...
        public static object[] CallMethod(string module, string func, params object[] args) {
            LuaManager luaMgr = AppFacade.Instance.GetComponentByName<LuaManager>(ComponentName.Lua);
